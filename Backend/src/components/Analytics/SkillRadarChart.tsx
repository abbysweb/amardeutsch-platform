    ...
    <div className="bg-white dark:bg-zinc-900/90 border border-zinc-200/80 dark:border-zinc-800/80 p-6 sm:p-8 rounded-3xl shadow-sm flex flex-col justify-between">
      <div>
        ...
        <p className="text-xs text-zinc-500 font-medium mb-6">
          Admin Audit: Multi-dimensional learner proficiency spectrum calculated directly from real user activity milestones.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              {activities.length > 0 && (
                <>
                  <polygon
                    ...
                    className="fill-indigo-500/25 stroke-indigo-500 dark:stroke-indigo-400 stroke-2 transition-all duration-700 ease-out drop-shadow-md"
                  />
          ...
          <div className="space-y-4">
            {hoveredAxis ? (
              <div className="bg-gradient-to-br from-zinc-900 via-zinc-950 to-zinc-900 text-white p-5 rounded-2xl border border-indigo-500/30 shadow-xl animate-fade-in space-y-2.5">
                <div className="flex items-center justify-between">
                  <span className="text-xl">{hoveredAxis.icon}</span>
                  <span className="text-xs font-black text-indigo-400 px-2.5 py-0.5 rounded-full bg-indigo-500/10 border border-indigo-500/20">
