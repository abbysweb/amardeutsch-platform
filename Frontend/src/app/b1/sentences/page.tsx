...
import { Sentences } from "@/levels/b1/modules/Sentences";
import { ErrorBoundary } from "@/shared/components/ErrorBoundary";

export default function B1SentencesPage() {
  return (
      ...
      <div className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-zinc-200">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-zinc-400">
            ...
            <span>/</span>
            <Link href="/b1" className="hover:text-zinc-600 transition-colors">B1</Link>
            <span>/</span>
