...
import { a2Sentences } from "@/levels/a2";
import SearchFilter from "@/shared/components/SearchFilter";
import { playGermanAudio } from "@/shared/utils/naturalTTS";
import CountUp from "@/shared/components/CountUp";

const sentencesData = a2Sentences as SentencePair[];
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-zinc-500 text-base">
          Learn A2 German in context with <strong className="text-zinc-900 font-semibold"><CountUp value={sentencesData.length} /> real example sentences</strong> covering daily life, work, travel, health, shopping, and hobbies.
        </p>
      </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <button
                    ...
                    className="shrink-0 w-10 h-10 rounded-full bg-amber-100 hover:bg-amber-200 transition-colors flex items-center justify-center text-sm text-amber-600"
