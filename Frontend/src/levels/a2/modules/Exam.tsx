      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-8 text-center">
          ...
          <p className={`text-lg font-medium ${passed ? "text-green-600" : "text-red-600"}`}>
            {passed ? "✅ PASSED - You're ready for A2!" : "❌ Not passed - Keep practicing"}
          </p>
          ...
          <button
            ...
            className="mt-8 px-6 py-3 bg-amber-400 text-zinc-900 font-medium rounded-lg hover:bg-amber-500 transition-colors"
          >
            Retake Exam
          </button>
        </div>
        ...
        <div className="bg-white rounded-xl border border-zinc-200 p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <div className="font-semibold text-amber-600">{section.timeLimitMinutes} min</div>
            </div>
          </div>
                ...
                <div key={question.id} className="bg-zinc-50 rounded-lg p-5 border border-zinc-100">
                  ...
                  {question.type === "fill-blank" && (
                    <input
                      ...
                      disabled={submitted}
                      className="w-full px-4 py-3 rounded-lg border bg-white text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent"
                  ...
                  {question.type === "translation" && (
                    <textarea
                      ...
                      disabled={submitted}
                      rows={3}
                      className="w-full px-4 py-3 rounded-lg border bg-white text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent resize-none"
                  ...
                  {question.type === "speaking" && (
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-left">
                      <p className="text-amber-800 text-sm mb-2">🎤 Speaking Exercise</p>
                      ...
                      <button
                        ...
                        disabled={submitted}
                        className="mt-3 px-4 py-2 bg-amber-100 text-amber-700 rounded-lg text-sm hover:bg-amber-200 transition-colors"
                      >
                        Mark as Practiced
                      </button>
                    </div>
              ...
              <div className="flex gap-3 justify-end">
                {isLastSection ? (
                  <button
                    ...
                    className="px-6 py-2.5 bg-amber-400 text-zinc-900 font-medium rounded-lg hover:bg-amber-500 transition-colors"
                  >
                    See Final Results
                  </button>
                ) : (
      ...
      {!submitted && (
        <div className="mt-6 flex justify-end">
          <button
            ...
            className="px-6 py-3 bg-amber-400 text-zinc-900 font-medium rounded-lg hover:bg-amber-500 transition-colors"
          >
            Submit Section
          </button>
        </div>
